// Get references to COM elements we need to manipulate
...
function search(e){
    ...
    const request = gapi.client.youtube.search.list({
        ...
        maxResults: 10,
        //set the search query ot search for
        q: searchTerm.value
    });
...
function displayVideo(result, i){
    ...
    //The YouTube Iframe Player API will replace each one with an <iframe> containing the corresponding video
    ...
    //if the duration is 0, the video can't e played, so we just delete it
